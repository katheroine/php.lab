...
10. [Standard PHP Library (SPL)](./spl/)
    ...
    2. [Iterators](./spl/iterators/)
        ...
        4. [Append iterator](./spl/iterators/append_iterator.php)
        5. [Empty iterator](./spl/iterators/empty_iterator.php)
        6. [Limit iterator](./spl/iterators/limit_iterator.php)
        7. [No rewind iterator](./spl/iterators/no_rewind_iterator.php)
