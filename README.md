...
10. [Built-in constructs & library](./library/)
    1. [Functions & methods](./library/functions/)
        ...
        3. [Magic methods](./library/functions/magic_methods/)
            ...
            3. [__call](./library/functions/magic_methods/__call.php)
            4. [__callStatic](./library/functions/magic_methods/__callStatic.php)
            5. [__invoke](./library/functions/magic_methods/__invoke.php)
            6. [__isset](./library/functions/magic_methods/__isset.php)
            7. [__unset](./library/functions/magic_methods/__unset.php)
            8. [__sleep](./library/functions/magic_methods/__sleep.php)
            9. [__wakeup](./library/functions/magic_methods/__wakeup.php)
            10. [__serialize](./library/functions/magic_methods/__serialize.php)
            11. [__unserialize](./library/functions/magic_methods/__unserialize.php)
            12. [__toString](./library/functions/magic_methods/__toString.php)
        ...
        4. [Autoloadig](./library/functions/autoloading/)
            ...
            4. [Autoload (SPL)](./library/functions/autoloading/spl_autoload.php)
            5. [Autoload extensions (SPL)](./library/functions/autoloading/spl_autoload_extensions.php)
    2. [Classes](./library/classes/)
        ...
        4. [Exceptions](./library/classes/exceptions/)
            ...
            2. [Error](./library/classes/exceptions/error.php)
            3. [Error exception](./library/classes/exceptions/error_exception.php)
            4. [Type error](./library/classes/exceptions/type_error.php)
            5. [Invalid argument exception (SPL)](./library/classes/exceptions/spl_invalid_argument_exception.php)
            6. [Value error](./library/classes/exceptions/value_error.php)
            7. [Argument count error](./library/classes/exceptions/argument_count_error.php)
            8. [Unexpected value exception (SPL)](./library/classes/exceptions/spl_unexpected_value_exception.php)
            9. [Bad function call exception (SPL)](./library/classes/exceptions/spl_bad_function_call_exception.php)
            10. [Bad method call exception (SPL)](./library/classes/exceptions/spl_bad_method_call_exception.php)
            11. [Arithmetic error](./library/classes/exceptions/arithmetic_error.php)
            12. [Division by zero error](./library/classes/exceptions/division_by_zero_error.php)
            13. [Unhandled match error](./library/classes/exceptions/unhandled_match_error.php)
            14. [Assertion error](./library/classes/exceptions/assertion_error.php)
            15. [Closed generator exception](./library/classes/exceptions/closed_generator_exception.php)
            16. [Logic exception (SPL)](./library/classes/exceptions/spl_logic_exception.php)
            17. [Length exception (SPL)](./library/classes/exceptions/spl_length_exception.php)
            18. [Out of bounds exception (SPL)](./library/classes/exceptions/spl_out_of_bounds_exception.php)
            19. [Out of range exception (SPL)](./library/classes/exceptions/spl_out_of_range_exception.php)
            20. [Overflow exception (SPL)](./library/classes/exceptions/spl_overflow_exception.php)
            21. [Underflow exception (SPL)](./library/classes/exceptions/spl_underflow_exception.php)
            22. [Range exception (SPL)](./library/classes/exceptions/spl_range_exception.php)
            23. [Domain exception (SPL)](./library/classes/exceptions/spl_domain_exception.php)
            24. [Runtime exception (SPL)](./library/classes/exceptions/spl_runtime_exception.php)
            25. [Parse error](./library/classes/exceptions/parse_error.php)
    ...
    3. [Interfaces](./library/interfaces/)
        ...
        3. [Iterators](./library/interfaces/iterators/)
            1. [Traversable](./library/interfaces/iterators/traversable.php)
            2. [Iterator](./library/interfaces/iterators/iterator.php)
            3. [Seekable iterator (SPL)](./library/interfaces/iterators/spl_seekable_iterator.php)
            4. [Iterator aggregate](./library/interfaces/iterators/iterator_aggregate.php)
            5. [Outer iterator (SPL)](./library/interfaces/iterators/spl_outer_iterator.php)
