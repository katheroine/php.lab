...
10. [Library](./library/)
    ...
    2. [Interfaces](./library/interfaces/)
        ...
        3. [Iterators](./library/interfaces/iterators/)
            ...
            3. [Iterator aggregate](./library/interfaces/iterators/iterator_aggregate.php)
            4. [Seekable iterator](./library/interfaces/iterators/seekable_iterator.php)
            5. [Recursive iterator](./library/interfaces/iterators/recursive_iterator.php)
            6. [Outer iterator](./library/interfaces/iterators/outer_iterator.php)
