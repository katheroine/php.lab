...
10. [Library](./library/)
    1. [Classes](./library/classes/)
        1. [Data](./library/classes/data/)
            1. [Closure](./library/classes/data/closure.php)
            2. [Generator](./library/classes/data/generator.php)
            3. [Array object (SPL)](./library/classes/data/spl_array_object.php)
            4. [Standard class](./library/classes/data/std_class.php)
