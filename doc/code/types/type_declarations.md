...
*Example: Typed pass-by-reference Parameters*
...
*Example: Old way to make arguments nullable*
...
* For *DNF (Disjunctive Normal Form) types*:
...
*Example: Basic class type declaration*
...
*Example: Basic interface type declaration*
...
*Example: Basic return type declaration*
...
*Example: Nullable argument type declaration*
...
*Example: Nullable return type declaration*
...
*Example: Class property type declaration*
...
*Example: Strict typing for arguments values*
...
*Example: Coercive typing for argument values*
...
*Example: Strict typing for return values*
...
-- [PHP Reference](https://www.php.net/manual/en/language.types.declarations.php)
