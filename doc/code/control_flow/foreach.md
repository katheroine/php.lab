...
[The [*`range` function*](https://www.php.net/manual/en/function.range.php) in the above example is not the [*generator*](https://www.php.net/manual/en/language.generators.overview.php) but maybe should be - KK]
...
**Availability**: PHP 5 >= 5.5.0, PHP 7, PHP 8
...
*Example: Iterate a constant array's values by reference*
...
-- [PHP Reference](https://www.php.net/manual/en/control-structures.foreach.php)
