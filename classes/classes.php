...
readonly class SomeUnchangeableClass
{
    ...
    public string $someObjectVariable;

    public function __construct()
    {
        $this->someObjectVariable = 'hi';
    }

    public static function someClassFunction(): void
    {
        print(
            SomeUnchangeableClass::SOME_CLASS_CONSTANT . PHP_EOL
            . self::SOME_CLASS_CONSTANT . PHP_EOL
            . PHP_EOL
        );
    }
...
SomeUnchangeableClass::someClassFunction();

$someUnchangeableObject = new SomeUnchangeableClass();
$someUnchangeableObject->someObjectFunction();

// $someUnchangeableObject->someObjectVariable = 'welcome';
